...
_minTimeBetweenWeatherChangesMin = 240;
...
_maxTimeBetweenWeatherChangesMin = 241;
...
_rainIntervalRainProbability = 25; //50
...
_forceRainToStopAfterOneRainInterval = true; //false
