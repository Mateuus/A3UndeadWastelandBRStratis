...
#define CLEANUP_INTERVAL (2*60) // Interval to run the cleanup
#define ITEM_CLEANUP_TIME (2*60) // Dropped player items cleanup time
#define DEBRIS_CLEANUP_TIME (2*60) // Vehicle crash crater/debris cleanup time (actual vehicle wreck cleanup is handled through description.ext parameters)
