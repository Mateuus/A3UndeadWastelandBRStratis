...
switch (_boxType) do
{
	case "mission_USLaunchers":
	{
		...
		[
			...
			["wep", ["launch_RPG32_F", "launch_NLAW_F", "launch_Titan_short_F"], RANDOM_BETWEEN(3,5), RANDOM_BETWEEN(3,5)],
			["wep", "launch_Titan_F", RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(4,5)],
			["bac", ["B_Carryall_mcamo"], RANDOM_BETWEEN(1,3)],
			["mag", ["SLAMDirectionalMine_Wire_Mag", "ATMine_Range_Mag"], RANDOM_BETWEEN(2,6)]
		];
	};
