...
[
	...
	["Titan MPRL Compact (Tan)", "launch_Titan_short_F", 7500],
	["Titan MPRL Compact (Brown)", "launch_O_Titan_short_F", 7500],
	["Titan MPRL Compact (Olive)", "launch_I_Titan_short_F", 7500],
	["Titan MPRL AA (Desert)", "launch_Titan_F", 7500],
...
[
	...
	["Mk6 Mortar (NATO)", "B_Mortar_01_F", 3000000],
	["Mk6 Mortar (CSAT)", "O_Mortar_01_F", 3000000],
	["Mk6 Mortar (AAF)", "I_Mortar_01_F", 3000000]
];

throwputArray = compileFinal str
[
	["Toxic Gas Grenade", "SmokeShellPurple", 500],
...
[
	...
	["UGV Stomper RCWS (NATO)", "B_UGV_01_rcws_F", 70000, "vehicle"],
	["UGV Stomper (AAF)", "I_UGV_01_F", 2500, "vehicle"],
	["UGV Stomper RCWS (AAF)", "I_UGV_01_rcws_F", 70000, "vehicle"],
	["UGV Saif (CSAT)", "O_UGV_01_F", 2500, "vehicle"],
	["UGV Saif RCWS (CSAT)", "O_UGV_01_rcws_F", 70000, "vehicle"]
];
...
[
	...
	["Hunter GMG", "B_MRAP_01_gmg_F", 30500, "vehicle"],
	["Ifrit", "O_MRAP_02_F", 4000, "vehicle"],
	["Ifrit HMG", "O_MRAP_02_hmg_F", 15000, "vehicle"],
	["Ifrit GMG", "O_MRAP_02_gmg_F", 30500, "vehicle"],
	["Strider", "I_MRAP_03_F", 4000, "vehicle"],
	["Strider HMG", "I_MRAP_03_hmg_F", 15000, "vehicle"],
	["Strider GMG", "I_MRAP_03_gmg_F", 30500, "vehicle"],
	["MSE-3 Marid", "O_APC_Wheeled_02_rcws_F", 40500, "vehicle"],
	["AMV-7 Marshall", "B_APC_Wheeled_01_cannon_F", 40500, "vehicle"],
	["AFV-4 Gorgon", "I_APC_Wheeled_03_cannon_F", 60000, "vehicle"]
];

tanksArray = compileFinal str
[
	["CRV-6e Bobcat", "B_APC_Tracked_01_CRV_F", 62500, "vehicle"],
...
[
	...
	["AH-9 Pawnee", "B_Heli_Light_01_armed_F", 80000, "vehicle"], // Armed AH-6
	["PO-30 Orca (Armed, Black)", "O_Heli_Light_02_v2_F", 60000, "vehicle"], // Armed Ka-60 with orca paintjob
	["PO-30 Orca (Armed, Hex)", "O_Heli_Light_02_F", 85000, "vehicle"], // Armed Ka-60
...
[
	["A-143 Buzzard AA", "I_Plane_Fighter_03_AA_F", 140000, "vehicle"],
	["A-143 Buzzard CAS", "I_Plane_Fighter_03_CAS_F", 145000, "vehicle"],
	["A-164 Wipeout CAS", "B_Plane_CAS_01_F", 160000, "vehicle"],
	["To-199 Neophron CAS", "O_Plane_CAS_02_F", 160000, "vehicle"],
	["MQ4A Greyhawk Missile UAV", "B_UAV_02_F", 120000, "vehicle"],
	["MQ4A Greyhawk Bomber UAV", "B_UAV_02_CAS_F", 110000, "vehicle"], // Bomber UAVs are a lot harder to use, hence why they are cheaper than Missile ones
	["K40 Ababil-3 Missile UAV (CSAT)", "O_UAV_02_F", 120000, "vehicle"],
	["K40 Ababil-3 Bomber UAV (CSAT)", "O_UAV_02_CAS_F", 110000, "vehicle"],
	["K40 Ababil-3 Missile UAV (AAF)", "I_UAV_02_F", 120000, "vehicle"],
	["K40 Ababil-3 Bomber UAV (AAF)", "I_UAV_02_CAS_F", 110000, "vehicle"]
];
